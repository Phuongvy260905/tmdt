const CommentModule = (function () {
  ...
  let mockComments = [
    {
      ...
      product: "RTX 4060 Ti",
      rating: 5,
      content: "Sản phẩm quá tuyệt vời, đóng gói kỹ.",
      date: "2026-03-15",
    },
    {
      id: 2,
      ...
      rating: 3,
      content: "Phím đẹp nhưng cảm giác gõ hơi lọc xọc.",
      date: "2026-03-16",
    },
    {
      id: 3,
      user: "Lê Minh Quân",
      avatar: "MQ",
      product: "Chuột Logitech G Pro",
      rating: 4,
      content: "Chuột nhẹ, sensor nhạy. Giá hơi cao.",
      date: "2026-03-17",
    },
    {
      id: 4,
      user: "Hoàng Yến",
      avatar: "HY",
      product: "Tai nghe Sony WH-1000",
      rating: 1,
      content: "Giao sai màu, rất thất vọng!",
      date: "2026-03-18",
    },
  ];
  ...
  function openModal(id) {
    ...
    document.getElementById("modal-stars").innerHTML = Array(5)
      .fill(0)
      .map(
        (_, i) =>
